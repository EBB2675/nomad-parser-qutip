...
a parser for QuTiP while extending the nomad-simulations schema
...
```sh
git clone https://github.com/EBB2675/nomad-parser-qutip.git
cd nomad-parser-qutip
